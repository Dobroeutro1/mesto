...
export const popupConfirm = document.querySelector('[data-popup-name=popup-confirm]');
export const popupUpdateImageProfile = document.querySelector('[data-popup-name=popup-update]');
